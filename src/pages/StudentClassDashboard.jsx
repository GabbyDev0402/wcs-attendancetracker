  ...
  return (
    <div className="space-y-6 animate-fade-in">
      ...
      <div className="flex border-b border-slate-200 dark:border-slate-800 space-x-6">
        ...
        <button
          disabled={true}
          className="pb-3 text-sm font-bold flex items-center space-x-2 border-b-2 border-transparent text-slate-400 dark:text-slate-600 cursor-not-allowed opacity-60 select-none"
        >
